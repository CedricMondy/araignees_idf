  ...
  sapply(
      ...
      cat(
        ...
        ifelse(
          ...
          paste0("<img src='", paste0('www/media/plots/', cd_ref, '.webp'), "' style='width: 100%; height: auto;'>"),
          ""
        ),
        ifelse(
          file.exists(paste0('www/media/plots/os_', cd_ref, '.webp')), 
          paste0("<img src='", paste0('www/media/plots/os_', cd_ref, '.webp'), "' style='width: auto; height: 500px; '>"),
          ''
        )
      )
      )
