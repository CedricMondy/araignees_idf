...
for (genus in genera) {
  ...
  sapply(
      ...
      cat(
        ...
        ''),
        "</div>" ,
        ifelse(!is.na(photo_male)||!is.na(photo_femelle), "<br>", ""),
        "<div class='flex-container'>",
        ...
        "</div><br>",
        paste0("<a href=https://www.galerie-insecte.org/galerie/", stringr::str_replace(species, pattern = " ", replacement = "_"), ".html target=\"_blank\"><img src=\"www/media/lmdi.png\" title=\"Galerie du site Le Monde des Insectes\" style=\"width: 50px; height: auto;\"></a><br>"),
