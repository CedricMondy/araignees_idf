...
for (genus in genera) {
  ...
  sapply(
      ...
      tailles <- especes_nmbe |> 
        ...
        dplyr::pull(size) |> 
        format_size()
      chronic <- paste0('www/media/plots/', cd_ref, '.webp')
      map <- paste0(
      ...
      plot_os <- paste0('www/media/plots/os_', cd_ref, '.webp')
      cat(
        paste0(
          "\n\n### *", species, "* (", 
          ifelse(is.na(difficulte), "non identifiable à vue", paste0("difficulté ", difficulte)),
          ") ", 
          ifelse(
            !is.na(statut_lr),
        ...
        ifelse(
          file.exists(chronic),
          paste0("<img src='", chronic, "' style='width: 100%; height: auto; margin:0;'>"),
          ""
        ),
        "<div class='flex-container-photo'>",
        "<div class='photo-container'>",
        "<a href='javascript:void(0)' onclick=\"openModal('", map, "')\">",
        paste0("<img src='", map, "' style='width: 100%; height: auto; cursor: pointer;'>"),
        "</a>",
        "</div>",
        "<div class='photo-container'>",
        ifelse(
          file.exists(plot_os),
          paste0(
            "<a href='javascript:void(0)' onclick=\"openModal('", plot_os, "')\">",
            "<img src='", plot_os, "' style='width: 100%; height: auto; cursor: pointer;'>",
            "</a>"
            ),
          ''
        ),
